      ...
      <li class="dropdown">
        ...
        <div class="dropdown-menu">
          <ul>
            ...
            <li><a href="index.php?page=nilaimahasiswa">Input Nilai Mahasiswa</a></li>
            <li><a href="index.php?laporan=nilaimahasiswa">Laporan Nilai (KHS)</a></li>
            <li class="line"></li>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-menu">
          <ul>
            ...
            <li><a href="index.php?page=penilaiankinerja">Data Penilaian Kinerja</a></li>
          </ul>
        </div>
      </li>
      <li class="dropdown">
        ...
        <div class="dropdown-menu">
          <ul>
            ...
            <li><a href="index.php?page=masteruk">Data Master UK</a></li>
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-menu">
          <ul>
            ...
            <li><a href="index.php?laporan=jadwalmk">Cetak Jawal Mata Kuliah</a></li>
          </ul>
        </div>
      </li>
    </ul>
